...
$petDec = isset($_POST['pet_des']) ? $_POST['pet_des'] : '';
...
$insertPetQuery = "INSERT INTO pets_tb(PET_TYPE, PET_BREED, PET_NAME, PET_BIRTH, PET_GENDER, PET_DEC, PET_OWNER, PET_IMG_NAME)
VALUES ('$petType', '$petBreed', '$petName', '$petBirth', '$petGender', '$petDec', '$petOwner', '$petImgName')";
